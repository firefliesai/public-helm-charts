...
Before you start make sure you have the following dependencies ready and
working:
...
availability, because the controller instance remain as Single-Point-Of-Failure.
...
You can define to spawn more worker, by set scaling.worker.count to a higher
number.
...
If you set `scaling.webhook.enabled=true`, then webhook processing on main
