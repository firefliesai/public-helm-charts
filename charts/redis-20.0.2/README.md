...
# Internal Fork: Bitnami package for Redis(R) - Version 20.0.2

> **Note**: This is an internal fork of the official Bitnami Redis Helm chart version 20.0.2. 
> This chart includes all dependencies and has been customized for internal use with custom container images.
> Original chart: https://github.com/bitnami/charts/tree/main/bitnami/redis
...
helm install my-release ./redis-20.0.2

# Or if packaged
helm install my-release redis-20.0.2.tgz
```
