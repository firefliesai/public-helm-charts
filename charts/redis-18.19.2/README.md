...
# Internal Fork: Bitnami package for Redis(R) - Version 18.19.2

> **Note**: This is an internal fork of the official Bitnami Redis Helm chart version 18.19.2.
> This chart includes all dependencies and has been customized for internal use.
...
helm install my-release ./redis-18.19.2

# Or if packaged
helm install my-release redis-18.19.2-internal.tgz
```
